...
const mounts = {
  ...
  examQuestionRoutes: "/api/exam-questions",
  chatRoutes: "/api/chat",
...
const document = {
  ...
  info: {
    ...
    version: "2.1.0",
    description:
      "Complete interactive reference generated from every route currently mounted by server.js. Authenticate with POST /api/auth/login, copy data.token, click Authorize, and enter the token. The same API also supports the HTTP-only token cookie.",
