...
const cmsPageSchema = new mongoose.Schema(
  {
    ...
    footerSection: { type: String, enum: ["about", "partnership", "services", "support"], default: "services" },
    footerOrder: { type: Number, default: 0 },
    pageTemplate: { type: String, enum: ["modern", "classic", "minimal"], default: "modern" },
    accentColor: { type: String, trim: true, default: "#123f88" },
    contentAlignment: { type: String, enum: ["left", "center"], default: "left" },
