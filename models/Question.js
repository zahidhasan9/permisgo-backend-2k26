...
const questionSchema = new mongoose.Schema(
  {
    ...
    questionVideoUrl: { type: String, default: "", trim: true },

    promptCount: { type: Number, enum: [1, 2], default: 1 },

    secondaryQuestionText: { type: String, default: "", trim: true },
    ...
    correctOptionIndexes: {
      ...
      default: undefined,
      validate: {
        validator: (value) => !value || (value.length >= 1 && value.length <= 4 && new Set(value).size === value.length),
        message: "Correct option indexes must contain 1 to 4 unique values.",
      },
    },
